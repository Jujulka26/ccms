...
def inject_styles():
    st.markdown(
        ...
        div[data-testid="stTabs"] [data-baseweb="tab-highlight"] {
            background-color: #9D63E8 !important;
        ...
        .pm-recommend {
            background: linear-gradient(135deg, rgba(157,99,232,0.06) 0%, #FFFFFF 100%);
        ...
        .pm-recommend-badge {
            ...
            text-transform: uppercase;
            color: #9D63E8;
            background: rgba(157,99,232,0.1);
            border: 1px solid rgba(157,99,232,0.2);
            border-radius: 20px;
            padding: 4px 12px;
            margin-bottom: 14px;
            font-family: 'Plus Jakarta Sans', sans-serif;
    ...
    st.markdown(
        ...
        <div class="pm-stat-grid">
            <div class="pm-stat-card">
                <div class="pm-stat-eyebrow" style="color:#9D63E8;font-family:'Plus Jakarta Sans',sans-serif;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;">Models compared</div>
            ...
            <div class="pm-stat-card">
                <div class="pm-stat-eyebrow" style="color:#5E8AEE;">Deployed model</div>
    ...
    if job_id:
        ...
        while True:
            ...
            with status_box.container():
                st.markdown(
                    f'<div style="background:rgba(157,99,232,0.06);border:1px solid rgba(157,99,232,0.2);'
                    f'border-radius:12px;padding:16px 20px;margin-bottom:4px;">'
                    f'<div style="font-size:12px;font-weight:600;color:#9D63E8;margin-bottom:6px;font-family:\'Plus Jakarta Sans\',sans-serif;letter-spacing:0.08em;">TRAINING IN PROGRESS</div>'
